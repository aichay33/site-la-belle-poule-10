...
export const metadata = buildPageMetadata({
  ...
  description: "Présentation optimisée de La Belle Poule pour les mairies, propriétaires et la Chambre d’agriculture de Gironde : projet avicole en préparation avant ouverture prévue le 01/05/2029.",
...
const guarantees = [
  "La ferme n’est pas ouverte aujourd’hui : ouverture prévue le 01/05/2029.",
  ...
  "Deux ateliers agricoles séparés : poules pondeuses et volailles de chair, sans mélange libre des lots.",
  "Volailles de chair : achat d’un noyau reproducteur de poules et coqs, puis reproduction naturelle sur la ferme.",
...
const benefits = [
  ...
  },
  {
    ...
    items: ["Un projet avicole spécialisé", "Une montée en charge progressive", "Deux ateliers identifiés", "Une logique plein air agroforestière", "Un besoin d’accompagnement structuré"],
  },
  {
    title: "Pour les habitants",
    items: ["Des œufs locaux", "Des volailles de chair sur réservation", "Un lieu propre et encadré", "Un parking, des toilettes publiques, une aire de pique-nique barbecue, une aire de jeux et un parcours d’observation", "Un projet porté par une personne identifiée"],
  },
];
...
export default function MairiesChambrePage() {
  return (
    <PageShell
      ...
      intro="Cette page présente La Belle Poule pour les communes, propriétaires, partenaires et structures agricoles : une future exploitation avicole plein air agroforestière, préparée pendant 3 ans avant l’ouverture prévue le 01/05/2029."
    >
      <div className="grid gap-10 text-text-mid">
        <section className="rounded-[2rem] bg-green-deep p-7 text-white md:p-9">
          ...
          <p className="mt-4 leading-8 text-white/85">
            La Belle Poule n’est pas une ferme ouverte aujourd’hui. C’est un projet en préparation, pensé pour devenir une exploitation avicole spécialisée, avec œufs, volailles de chair, paddocks plein air agroforestiers, vente directe et accueil encadré des parties communes.
          </p>
        </section>
        ...
        <section className="rounded-[2rem] bg-cream-soft p-7 md:p-9">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-4">
            <div className="rounded-2xl bg-white p-5"><p className="text-xs font-bold uppercase tracking-[0.18em] text-terracotta">Ouverture</p><p className="mt-2 text-xl font-bold text-green-deep">01/05/2029</p></div>
            ...
            <div className="rounded-2xl bg-white p-5"><p className="text-xs font-bold uppercase tracking-[0.18em] text-terracotta">Chair</p><p className="mt-2 text-xl font-bold text-green-deep">reproduction naturelle</p></div>
            <div className="rounded-2xl bg-white p-5"><p className="text-xs font-bold uppercase tracking-[0.18em] text-terracotta">Objectif</p><p className="mt-2 text-xl font-bold text-green-deep">1 000 + 1 000</p></div>
          </div>
        </section>
        ...
        <section className="grid gap-5 md:grid-cols-4">
          ...
          <Link href="/systeme-eau" className="rounded-2xl bg-white p-5 leading-7 shadow-[0_12px_40px_rgba(31,36,24,0.05)]"><strong className="text-green-deep">Système d’eau</strong><br />Voir la gestion pluie et appoint atmosphérique.</Link>
