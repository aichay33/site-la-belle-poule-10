...
export const metadata = buildPageMetadata({
  ...
  description: "Plan de préparation de La Belle Poule : 3 ans avant ouverture le 01/05/2029 pour préparer le terrain, l’eau, le solaire, les paddocks, les bâtiments, la sécurité et les ateliers avicoles.",
  path: "/plan-3-ans",
...
const years = [
  ...
  },
  {
    ...
    items: ["4 paddocks agroforestiers", "Zone pondeuses distincte", "Zone volailles de chair distincte", "Abris / poulaillers adaptés", "Point de vente, toilettes publiques, aire de pique-nique barbecue, aire de jeux et distributeur œufs/boissons", "Parcours client 10h-19h", "Préparation du noyau reproducteur chair et des fournisseurs pondeuses"],
  },
  {
    title: "Année 3 — Finaliser avant ouverture",
    text: "La troisième année sert à peaufiner les détails avant l’ouverture prévue le 01/05/2029 : sécurité, eau, signalétique, organisation sanitaire, clients, commandes et partenaires.",
    items: ["Tests techniques sans ouverture commerciale", "Finalisation du système d’eau", "Signalétique et séparation des zones", "Distributeur H24 sécurisé", "Liste de futurs clients", "Lien LinkedIn intégré et futur lien BD à ajouter", "Préparation ouverture avec 240 pondeuses et noyau reproducteur chair"],
  },
];
...
export default function PlanTroisAnsPage() {
  return (
    <PageShell
      ...
      title="3 ans pour préparer la ferme avant l’ouverture du 01/05/2029"
      intro="La Belle Poule ne sera pas ouverte avant le 01/05/2029. Cette période permet de construire une exploitation avicole propre, sécurisée, organisée et prête à fonctionner avant l’arrivée des animaux et des clients."
    >
      <div className="grid gap-10 text-text-mid">
        <section className="rounded-[2rem] bg-green-deep p-7 text-white md:p-9">
          ...
          <p className="mt-4 leading-8 text-white/85">
            Avant le 01/05/2029, La Belle Poule est une ferme en préparation. Cette information doit rassurer les mairies : le site n’est pas présenté comme déjà ouvert, et l’activité agricole n’est lancée qu’une fois les installations prêtes.
          </p>
        </section>
        ...
        <section className="rounded-[2rem] bg-cream-soft p-7 md:p-9">
          ...
          <p className="mt-4 leading-8">
            À l’ouverture prévue le 01/05/2029, La Belle Poule vise 240 poules pondeuses, un noyau reproducteur pour les volailles de chair, une vente directe prête, un distributeur d’œufs et de boissons en H24, un parking, des toilettes publiques, une aire de pique-nique barbecue, une aire de jeux pour enfants et un accueil des parties communes de 10h à 19h.
          </p>
          <p className="mt-4 leading-8">
            L’objectif final de 1 000 pondeuses et 1 000 volailles de chair/an est une perspective de maturité, pas un départ immédiat. L’augmentation se fera uniquement si la demande client, l’organisation, les autorisations et la sécurité le permettent.
          </p>
        </section>
      </div>
    </PageShell>
