...
export const metadata = buildPageMetadata({
  ...
  description: "Dossier de présentation de La Belle Poule : future exploitation avicole plein air agroforestière en Gironde, ouverture prévue le 05/2029, œufs, atelier œufs uniquement et vente directe.",
  path: "/dossier-projet",
  keywords: ["dossier projet agricole", "exploitation avicole Gironde", "œufs plein air Gironde", "poules pondeuses Gironde"],
});

const steps = [
  "Projet en préparation : ouverture prévue le 05/2029.",
  ...
  "Montée progressive des poules pondeuses uniquement si la demande locale suit.",
  "Objectif progressif : jusqu’à 1 000 poules pondeuses à terme si la demande, les autorisations et l’organisation suivent.",
  "Système d’eau : pluie, stockage, distribution gravitaire et infiltration sans mare obligatoire.",
];
      ...
      <div className="grid gap-10 text-text-mid">
        <section className="grid gap-6 md:grid-cols-[0.95fr_1.05fr] md:items-start">
          ...
          <dl className="grid gap-3 rounded-[2rem] bg-cream-soft p-6 text-sm leading-6">
            <div><dt className="font-bold text-green-deep">Activité principale</dt><dd>Exploitation avicole : œufs plein air</dd></div>
            <div><dt className="font-bold text-green-deep">Ouverture</dt><dd>Prévue le 05/2029</dd></div>
            <div><dt className="font-bold text-green-deep">Pondeuses</dt><dd>240 à l’ouverture, augmentation selon la demande</dd></div>
            <div><dt className="font-bold text-green-deep">Objectif</dt><dd>Jusqu’à 1 000 poules pondeuses à terme si le marché suit</dd></div>
        ...
        <section className="rounded-[2rem] border border-green-deep/10 bg-white p-7 md:p-9 shadow-[0_12px_40px_rgba(31,36,24,0.05)]">
          ...
          <p className="mt-4 leading-8">
            Un dossier de présentation concis est disponible pour les mairies, propriétaires, partenaires et structures d’accompagnement agricole. Il rappelle que la ferme n’est pas ouverte avant le 05/2029 et présente le projet plein air • agroforesterie, l’atelier œufs, le plan de préparation, l’eau, les paddocks, la zone publique avec parking, toilettes, pique-nique barbecue, aire de jeux, la sécurité et les garanties du projet.
          </p>
        ...
        <section className="grid gap-5 md:grid-cols-4">
          ...
          <Link href="/systeme-verger" className="rounded-2xl bg-white p-5 leading-7 shadow-[0_12px_40px_rgba(31,36,24,0.05)]"><strong className="text-green-deep">Paddocks</strong><br />Paddocks et rotations prévus.</Link>
          <Link href="/systeme-eau" className="rounded-2xl bg-white p-5 leading-7 shadow-[0_12px_40px_rgba(31,36,24,0.05)]"><strong className="text-green-deep">Système d’eau</strong><br />Pluie, stockage et distribution.</Link>
