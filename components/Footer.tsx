...
export default function Footer() {
  return (
    <footer className="border-t border-green-deep/10 bg-cream-soft">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-12 md:grid-cols-[1fr_1.1fr_0.9fr] md:px-8">
        <div>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <span className="rounded-full bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-green-deep">Ouverture 01/05/2029</span>
          </div>
        </div>
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-[0_15px_40px_rgba(31,36,24,0.05)] md:text-center">
          ...
          <p className="mt-3 text-sm leading-7 text-text-mid">La Belle Poule recherche un terrain agricole uniquement en Gironde, idéalement 4 hectares, pour préparer une ferme avicole avant ouverture : œufs, volailles de chair, paddocks arborés et vente directe.</p>
      ...
      <div className="border-t border-green-deep/10 py-5 text-center text-xs text-text-mid">© 2026 La Belle Poule — Projet en préparation, ouverture prévue le 01/05/2029</div>
    </footer>
  );
}
